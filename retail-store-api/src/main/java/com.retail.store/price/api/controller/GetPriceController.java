...
import com.retail.store.commons.constants.Constants;
import com.retail.store.commons.utils.ApiVersion;
import com.retail.store.price.api.response.GetPriceResponse;
import com.retail.store.price.api.validator.BrandIdValid;
import com.retail.store.price.api.validator.ProductIdValid;
...
public interface GetPriceController {
  ...
  @Operation(
      summary = "Get prices",
      description =
          "This operation returns price for introduced data",
      parameters = {
          @Parameter(
              in = QUERY,
